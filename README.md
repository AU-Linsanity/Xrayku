...
* 端口：443
* 默认UUID：190190f5-d88c-48da-85b7-797bc3d9399f
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 路径：/190190f5-d88c-48da-85b7-797bc3d9399f-vless // 默认vless使用/$uuid-vless，vmess使用/$uuid-vmess
* 底层传输安全：tls
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "190190f5-d88c-48da-85b7-797bc3d9399f"
    ],
    "websocket": {
        "enabled": true,
        "path": "/190190f5-d88c-48da-85b7-797bc3d9399f-trojan",
...
* 端口: 443
* 密码：190190f5-d88c-48da-85b7-797bc3d9399f
* 加密：chacha20-ietf-poly1305
* 插件程序：xray-plugin_windows_amd64.exe  //需将插件https://github.com/shadowsocks/xray-plugin/releases下载解压后放至shadowsocks同目录
* 插件选项: tls;host=appname.herokuapp.com;path=/190190f5-d88c-48da-85b7-797bc3d9399f-ss
```
</details>
